...
static OMX_ERRORTYPE virtual_Prepare(
	...
	dispInPortRoot = ooc_cast(MagOmxPort, dispInPort);
...
static void MagOmxComponent_DispTest_destructor(MagOmxComponent_DispTest thiz, MagOmxComponentVideoVtable vtab){
	AGILE_LOGV("Enter!");
}
...
static OMX_ERRORTYPE MagOmxComponent_DispTest_Init(OMX_OUT OMX_HANDLETYPE *hComponent,  
    ...
    hVDispComp = (MagOmxComponent_DispTest) ooc_new( MagOmxComponent_DispTest, NULL);
