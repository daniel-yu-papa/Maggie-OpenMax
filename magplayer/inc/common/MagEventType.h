#ifndef __MAG_EVENT_TYPE_H__
#define __MAG_EVENT_TYPE_H__
...
enum media_info_type {
    ...
    MEDIA_INFO_PLAY_COMPLETE   = 4,
    
    // 7xx
    // MediaPlayer is temporarily pausing playback internally in order to
    // buffer more data. the parameter indicates the buffering status: 
    // 0 - start the buffering
    // 100 - end of the buffering and start the playing
    // (1-100) - the buffer filling percentage for resuming the play
    MEDIA_INFO_BUFFERING_REPORT = 700,
