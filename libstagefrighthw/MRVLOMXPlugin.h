...
#ifndef MRVL_OMX_PLUGIN_H_

#define MRVL_OMX_PLUGIN_H_

#include <OMXPluginBase.h>

namespace android {

struct MRVLOMXPlugin : public OMXPluginBase {
    MRVLOMXPlugin();
    virtual ~MRVLOMXPlugin();
...
private:
    ...
    MRVLOMXPlugin(const MRVLOMXPlugin &);
    MRVLOMXPlugin &operator=(const MRVLOMXPlugin &);
};

}  // namespace android

#endif  // MRVL_OMX_PLUGIN_H_